...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(796, 612)
        sizePolicy = QSizePolicy(QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(MainWindow.sizePolicy().hasHeightForWidth())
        MainWindow.setSizePolicy(sizePolicy)
        MainWindow.setMinimumSize(QSize(796, 612))
...
"color: rgb(0, 0, 0);")
        ...
        self.city_label.setGeometry(QRect(210, 0, 321, 50))
        ...
        font1 = QFont()
        font1.setFamilies([u"SpaceMono Nerd Font"])
...
"color: rgb(0, 0, 0);")
        ...
        font2 = QFont()
        font2.setFamilies([u"Ubuntu Nerd Font"])
...
"color: rgb(0, 0, 0);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Search for text..", None))
